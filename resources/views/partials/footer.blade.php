        ...
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 mb-12 md:w-1/4">
                    ...
                    <ul class="text-slate-300">
                        <li>
                            <a href="https://www.linkedin.com/in/marcellinus-yovian-indrastata/" target="_blank"
                                class="flex text-base hover:text-primary mb-3 transition duration-300">
                        ...
                        <li>
                            <a href="https://instagram/marcyovian" target="_blank"
                                class="flex text-base hover:text-primary mb-3 transition duration-300">
                                <svg role="img" class="w-5 me-2 fill-current" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
