...
<body class="">
    ...
    <section id="portfolio" class="bg-dark-semi pt-36 pb-16">
        <div class="container">
            <div class="w-full px-4">
                <div class="mx-auto mb-16 max-w-xl text-center">
                    <h3 class="text-base font-semibold text-white md:text-lg xl:text-2xl">Diverse Web and Mobile
                        Creations</h3>
                    <h1 class="text-4xl font-bold text-primary md:text-5xl xl:text-6xl mb-2 xl:mb-4">PROJECTS SHOWCASE
                    </h1>
                    <p class="mb-8 text-xs font-medium leading-relaxed md:text-sm text-third">Explore my diverse
                        portfolio
                        featuring web
